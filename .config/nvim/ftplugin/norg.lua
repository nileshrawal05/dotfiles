...
vim.keymap.set("n", "<localleader>e",   "<Plug>(neorg.looking-glass.magnify-code-block)", {desc = "edit code in separate window"})
...
vim.keymap.set("n", "<localleader>nn",   "<Plug>(neorg.dirman.new-note)", {desc = "Create new norg file"})
